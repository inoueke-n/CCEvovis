...
public class Def {
	 ...
	 * ICVolti
	 */
	public static final String ICV_TOOLNAME = "ICVolti";

	/**
	 * ICVolti へのパス
	 */
	public static final String ICV_DIR = "icvolti";
	 ...
	 * SourcererCC
	 */
	public static final String NO_TOOLNAME = "NoTool";
	...
	public static boolean isValidLang(String lang, String tool) {
		...
		} else if (tool.equals(Def.NO_TOOLNAME)) {
			if (lang.equals("c") || lang.equals("cobol") || lang.equals("plaintext") || lang.equals("cpp") || lang.equals("java") || lang.equals("csharp") || lang.equals("js")
					|| lang.equals("python")) {
				return true;
			}
		}
